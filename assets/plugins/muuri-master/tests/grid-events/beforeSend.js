(function (window) {
  ...
  QUnit.test('beforeSend: should be triggered in the beginning of the send procedure (for the sending grid)', function (assert) {
  ...
  QUnit.test('beforeSend: should be triggered when an item is dragged into another grid (for the sending grid)', function (assert) {
